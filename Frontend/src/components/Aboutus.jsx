...
function Aboutus() {
  return (
    <section className="text-gray-600 body-font rounded-lg bg-white max-w-[90%] m-auto">
      <div className="container px-32 py-16 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="text-4xl text-center font-medium title-font mb-4 text-black tracking-widest">
            OUR TEAM
          </h1>
        </div>
