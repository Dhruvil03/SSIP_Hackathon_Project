...
function Modal({ setLoginmodal }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // setAuth on login
      setAuth({ userId, name, email: newEmail, role, accessToken });
        ...
        <form>
          <div className="relative mb-4">
            ...
            <input
              ...
              value={email}
              className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3  transition-colors duration-200 ease-in-out"
            />
          </div>
          <div className="relative mb-4">
